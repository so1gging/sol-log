...
const projects: Project[] = [
  {
    ...
    details: [
      ...
      "인터랙션 개선을 통해 서버 트래픽과 응답 지연 문제 완화",
      "서버 상태 라이브러리를 활용한 UX 응답성 개선",
      "UI-API 간 브릿지 계층 설계로 필터 컴포넌트가 서버 스펙 변화에 독립적으로 동작하도록 구현",
      "반복적인 수동 QA 체크리스트를 E2E 테스트로 자동화하여 배포 품질과 안정성 향상",
      "CI/CD 배포 파이프라인 병렬 처리 및 캐싱 전략으로 평균 배포시간 50% 이상 단축",
    ],
  },
  {
    id: "2",
