    ...
    <html lang="en">
      <body>
        ...
        <section id="experience">
          ...
          <div className="job-item">
            <h4>
              ...
              <p className="rule">
                자사 데이터솔루션 RA 서비스 PoC 부터 서비스 런칭까지 메인
                개발자로 참여하였습니다.
              </p>
            </h4>
            <div className="history">
              <ul>
                <li>
                  JavaScript기반 Static Map API 를 React 컴포넌트로 래핑해 사내
                  맵 라이브러리 구축
                </li>
                <li>API 캐시 및 상태 관리 최적화하여 성능 개선</li>
                <li>Cypress 기반 E2E 테스트 자동화 구축</li>
                <li>
                  소나큐브 및 데이터독 기반 에러 트래킹 및 정적 분석으로 코드
                  품질 향상 기여
                </li>
              </ul>
            </div>
        ...
        <section id="introduction">
          ...
          <p>
            저는 React와 Next.js를 중심으로 TypeScript를 사용하는 6년차
            프론트엔드 개발자입니다. <br /> 저는 프론트엔드 개발을 단순히 화면을
            구성하는 작업으로 보지 않습니다. <br /> 프론트엔드 개발자는 사용자와
            가장 밀접하게 닿아있기에 요구사항을 빠르게 반영하고 사용자 경험을
            개선해 나가는 역할이라고 생각합니다.
            <br /> 그렇기에 항상 사용자의 입장에서 고민하고, 요구사항을
            적극적으로 듣고 이해한 뒤, 더 나은 방향을 제안하려 노력합니다.{" "}
            <br /> 제품 개발 과정에서 제가 가장 중요하게 여기는 가치는
            ‘협업’입니다. 개인의 완벽함보다, 팀원들과 함께 문제를 해결하고
            제품을 완성해 나가는 과정을 더 중요하게 생각합니다. 이를 위해 다양한
            이해관계자들과 원활하게 소통하는 환경을 지향하고 있습니다.
        ...
        <footer>
          마지막 업데이트: 2025년 9월 · Designed & Built by 김솔지
        </footer>
      </body>
    </html>
  );
